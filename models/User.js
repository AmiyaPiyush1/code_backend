    ...
    password: { 
        ...
        validate: {
            validator: function(value) {
                ...
                if (!hasNoSpaces) {
                    this.invalidate('password', 'Password cannot contain spaces');
                }
                
                return hasUpperCase && hasLowerCase && hasNumbers && hasSpecialChar && hasNoSpaces;
            }
        }
    },
    name: { 
    ...
    picture: { 
        ...
        validate: {
            validator: function(value) {
                ...
                return value.startsWith('data:image') || validator.isURL(value);
            },
